...
const News = () => {
  return (
    <div className="news-container">
      <h1 style={{fontSize: "45px"}} className="news-title">Recent news</h1>
      <div className="news-grid">
        <div className="news-main">
          ...
          <div className="news-content">
            ...
            <p className="news-summary">Ipsum aliquet nisi, hendrerit rhoncus quam tortor, maecenas faucibus. Tincidunt aliquet sit vel, venenatis nulla...</p>
          </div>
        </div>
